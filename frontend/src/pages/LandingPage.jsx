    ...
    <>
      ...
      <div className="landing-page">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url(https://www.guidanceforever.org/wp-content/uploads/2023/11/visvesvaraya-technological-university-belgaum-featured.jpg)",
        ...
        {schedule && (
          <section className="schedule-section">
            <div className="schedule-header">
              <div className="section-icon" style={{ fontSize: "4rem" }}>
                {schedule.icon}
              </div>
                    ...
                    {day.events.map((event, eventIndex) => (
                      <div key={eventIndex} className="event-item">
                        ...
                        <div className="event-details">
                          ...
                          <div className="event-responsible">
                            {event.responsible}
                          </div>
                        </div>
                      </div>
